 ...
 * @method     ChildBook[]|Collection findById(int $id) Return ChildBook objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildBook> findById(int $id) Return ChildBook objects filtered by the id column
 * @method     ChildBook[]|Collection findByTitle(string $title) Return ChildBook objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildBook> findByTitle(string $title) Return ChildBook objects filtered by the title column
 * @method     ChildBook[]|Collection findByISBN(string $isbn) Return ChildBook objects filtered by the isbn column
 * @psalm-method Collection&\Traversable<ChildBook> findByISBN(string $isbn) Return ChildBook objects filtered by the isbn column
 * @method     ChildBook[]|Collection findByPublisherId(int $publisher_id) Return ChildBook objects filtered by the publisher_id column
 * @psalm-method Collection&\Traversable<ChildBook> findByPublisherId(int $publisher_id) Return ChildBook objects filtered by the publisher_id column
 * @method     ChildBook[]|Collection findByAuthorId(int $author_id) Return ChildBook objects filtered by the author_id column
 * @psalm-method Collection&\Traversable<ChildBook> findByAuthorId(int $author_id) Return ChildBook objects filtered by the author_id column
...
abstract class BookQuery extends ModelCriteria
{
     ...
     * Use the Publisher relation Publisher object
     *
     * @param callable(\DB\PublisherQuery):\DB\PublisherQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \DB\PublisherQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \DB\PublisherQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * Use the Author relation Author object
     *
     * @param callable(\DB\AuthorQuery):\DB\AuthorQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \DB\AuthorQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \DB\AuthorQuery The inner query object of the NOT EXISTS statement
     */
