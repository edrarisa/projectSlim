...
abstract class Users implements ActiveRecordInterface
{
    ...
    /**
     * The value for the idregistro field.
     *
     * @var        int
     */
    ...
    /**
     * Get the [idregistro] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [idregistro] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setIdregistro($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->idregistro !== $v) {
            $this->idregistro = $v;
            $this->modifiedColumns[UsersTableMap::COL_IDREGISTRO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[UsersTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setCiudad($v)
    {
        ...
        if ($this->ciudad !== $v) {
            $this->ciudad = $v;
            $this->modifiedColumns[UsersTableMap::COL_CIUDAD] = true;
        }
    ...
    public function setDepartamento($v)
    {
        ...
        if ($this->departamento !== $v) {
            $this->departamento = $v;
            $this->modifiedColumns[UsersTableMap::COL_DEPARTAMENTO] = true;
        }
    ...
    public function setAsunto($v)
    {
        ...
        if ($this->asunto !== $v) {
            $this->asunto = $v;
            $this->modifiedColumns[UsersTableMap::COL_ASUNTO] = true;
        }
    ...
    public function setMensaje($v)
    {
        ...
        if ($this->mensaje !== $v) {
            $this->mensaje = $v;
            $this->modifiedColumns[UsersTableMap::COL_MENSAJE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UsersTableMap::translateFieldName('Idregistro', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idregistro = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsersTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsersTableMap::translateFieldName('ISBN', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Ciudad', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ciudad = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('Departamento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->departamento = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('Asunto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->asunto = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UsersTableMap::translateFieldName('Mensaje', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mensaje = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[UsersTableMap::COL_IDREGISTRO] = true;
        if (null !== $this->idregistro) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . UsersTableMap::COL_IDREGISTRO . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(UsersTableMap::COL_IDREGISTRO)) {
            $modifiedColumns[':p' . $index++]  = 'idregistro';
        }
        if ($this->isColumnModified(UsersTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(UsersTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(UsersTableMap::COL_CIUDAD)) {
            $modifiedColumns[':p' . $index++]  = 'ciudad';
        }
        if ($this->isColumnModified(UsersTableMap::COL_DEPARTAMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'departamento';
        }
        if ($this->isColumnModified(UsersTableMap::COL_ASUNTO)) {
            $modifiedColumns[':p' . $index++]  = 'asunto';
        }
        if ($this->isColumnModified(UsersTableMap::COL_MENSAJE)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idregistro':
                        $stmt->bindValue($identifier, $this->idregistro, PDO::PARAM_INT);
                        break;
                    case 'nombre':
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            $keys[0] => $this->getIdregistro(),
            $keys[1] => $this->getNombre(),
            $keys[2] => $this->getISBN(),
            $keys[3] => $this->getCiudad(),
            $keys[4] => $this->getDepartamento(),
            $keys[5] => $this->getAsunto(),
            $keys[6] => $this->getMensaje(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setCiudad($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setDepartamento($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setAsunto($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setMensaje($arr[$keys[6]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_IDREGISTRO)) {
            $criteria->add(UsersTableMap::COL_IDREGISTRO, $this->idregistro);
        }
        if ($this->isColumnModified(UsersTableMap::COL_NOMBRE)) {
            $criteria->add(UsersTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(UsersTableMap::COL_EMAIL)) {
            $criteria->add(UsersTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CIUDAD)) {
            $criteria->add(UsersTableMap::COL_CIUDAD, $this->ciudad);
        }
        if ($this->isColumnModified(UsersTableMap::COL_DEPARTAMENTO)) {
            $criteria->add(UsersTableMap::COL_DEPARTAMENTO, $this->departamento);
        }
        if ($this->isColumnModified(UsersTableMap::COL_ASUNTO)) {
            $criteria->add(UsersTableMap::COL_ASUNTO, $this->asunto);
        }
        if ($this->isColumnModified(UsersTableMap::COL_MENSAJE)) {
            $criteria->add(UsersTableMap::COL_MENSAJE, $this->mensaje);
        }
    ...
    {
        $validPk = null !== $this->getIdregistro();
    ...
    /**
     * Generic method to set the primary key (idregistro column).
     *
    ...
    {
        return null === $this->getIdregistro();
    }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdregistro(NULL); // this is a auto-increment column, so set to default value
        }
    }
